...
class AppSetting extends Model implements HasMedia
{
    ...
    protected $fillable = ['daily_text_limit', 'text_length', 'site_name', 'site_email', 'site_logo', 'site_favicon', 'site_description', 'site_copyright', 'facebook_url', 'twitter_url', 'linkedin_url', 'language_option', 'contact_email', 'contact_number', 'instagram_url', 'notification_settings', 'help_support_url'];
